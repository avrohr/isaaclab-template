...
@configclass
class CustomCartpoleEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 2
...
class CustomCartpoleEnv(DirectRLEnv):
    cfg: CustomCartpoleEnvCfg

    def __init__(self, cfg: CustomCartpoleEnvCfg, render_mode: str | None = None, **kwargs):
